...
def extract_keywords_tfidf(new_job_description, vectorizer, num_keywords=10):
    """
...
if __name__ == '__main__':
    ...
    # Step 3: Define a new job description for which to extract keywords.
    new_job_description = """
    We are looking for a skilled DevOps engineer with expertise in container orchestration,
    continuous integration, and cloud infrastructure. Experience with Docker, Kubernetes,
    and AWS is required.
    """
    ...
    print("Top keywords from the new job description (TF-IDF):")
